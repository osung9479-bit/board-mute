...
- 네이트판: 글 보기 본문 작성자, 댓글 작성자, 사이드바/추천/베스트 목록, 검색 결과, 모바일 웹, 로그인 후 개인화 영역
...
- `작성자/아이디/IP`에는 직접 차단할 작성자 값을 추가하거나 삭제할 수 있습니다. 사람인과 잡코리아에서는 같은 저장 영역을 `회사/공고 숨김값`으로 표시합니다.
...
- 남은 작업: public repository export/precheck, 필요 시 커밋과 push, Chrome Web Store 제출, 추가 사이트 확장과 제품 품질 개선
